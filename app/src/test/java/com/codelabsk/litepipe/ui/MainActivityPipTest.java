...
public class MainActivityPipTest {
	...
	public void shouldSuppressPictureInPictureForStartedActivity_onlyForExplicitInAppActivities() {
		...
		when(inAppComponent.getPackageName()).thenReturn("com.codelabsk.com.codelabsk.litepipe");
		when(externalIntent.getComponent()).thenReturn(null);

		assertTrue(MainActivity.shouldSuppressPictureInPictureForStartedActivity(inAppIntent, "com.codelabsk.com.codelabsk.litepipe"));
		assertFalse(MainActivity.shouldSuppressPictureInPictureForStartedActivity(externalIntent, "com.codelabsk.com.codelabsk.litepipe"));
		assertFalse(MainActivity.shouldSuppressPictureInPictureForStartedActivity(null, "com.codelabsk.com.codelabsk.litepipe"));
	}
