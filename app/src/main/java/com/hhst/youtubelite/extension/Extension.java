    ...
    public static List<Extension> defaultExtensionTree() {
        return List.of(
            ...
            new Extension(null, R.string.shorts, List.of(
                new Extension(Constant.HIDE_SHORTS_BUTTONS, R.string.hide_shorts_buttons, List.of(
                    new Extension(Constant.SHORTS_SHOW_LIKE, R.string.shorts_show_like, null),
                    new Extension(Constant.SHORTS_SHOW_DISLIKE, R.string.shorts_show_dislike, null),
                    new Extension(Constant.SHORTS_SHOW_COMMENTS, R.string.shorts_show_comments, null),
                    new Extension(Constant.SHORTS_SHOW_SHARE, R.string.shorts_show_share, null),
                    new Extension(Constant.SHORTS_SHOW_REMIX, R.string.shorts_show_remix, null),
                    new Extension(Constant.SHORTS_SHOW_SUBSCRIBE, R.string.shorts_show_subscribe, null)
                )),
                new Extension(Constant.SHORTS_GESTURES, R.string.shorts_gestures, List.of(
                    new Extension(Constant.SHORTS_GESTURE_2X, R.string.shorts_gesture_2x, null),
                    new Extension(Constant.SHORTS_GESTURE_SEEK, R.string.shorts_gesture_seek, null),
                    new Extension(Constant.SHORTS_GESTURE_VOLUME, R.string.shorts_gesture_volume, null)
                )),
            ...
            new Extension(null, R.string.player, List.of(
                ...
                new Extension(Constant.PLAYER_GESTURES, R.string.player_gestures, List.of(
                    new Extension(Constant.PLAYER_GESTURE_BRIGHTNESS, R.string.brightness, null),
                    new Extension(Constant.PLAYER_GESTURE_VOLUME, R.string.volume, null),
                    new Extension(Constant.PLAYER_GESTURE_SEEK, R.string.shorts_gesture_seek, null),
                    new Extension(Constant.PLAYER_GESTURE_2X, R.string.shorts_gesture_2x, null),
                    new Extension(Constant.DOUBLE_TAP_SEEK_AMOUNT, R.string.double_tap_seek_amount, null)
                )),
