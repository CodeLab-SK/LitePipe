        ...
        return List.of(
            ...
            new Extension(null, R.string.player, List.of(
                ...
                new Extension(Constant.CUSTOMIZE_PLAYER_BUTTONS, R.string.player_buttons, R.string.player_buttons_desc, List.of(
                    ...
                    new Extension(Constant.PLAYER_SHOW_REMAINING_DURATION, R.string.show_remaining_duration, null)
                )),
                new Extension(Constant.PLAYER_GESTURES, R.string.player_gestures, List.of(
                    ...
                    new Extension(Constant.PLAYER_GESTURE_SEEK, R.string.Seek, null),
            ...
            new Extension(null, R.string.download, List.of(
                ...
                new Extension(Constant.DOWNLOAD_MAX_CONCURRENT, R.string.max_concurrent_downloads, null),
                new Extension(Constant.DOWNLOAD_CLIPBOARD_DETECTION, R.string.download_clipboard_detection, null)
            ))
        );
    }
}
