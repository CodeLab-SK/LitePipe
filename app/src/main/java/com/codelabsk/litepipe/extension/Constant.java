...
public final class Constant {
    ...
    public static final String NAV_BAR_SHOW_HISTORY = "nav_bar_show_history";
    public static final String NAV_BAR_SHOW_PLAYLISTS = "nav_bar_show_playlists";
    ...
    public static final String DEFAULT_NAV_BAR_ORDER = "home,shorts,music,subscriptions,library,history,playlists,downloads,settings";
    ...
    public static final Map<String, Object> DEFAULT_PREFERENCES = Map.ofEntries(
            ...
            Map.entry(NAV_BAR_SHOW_HISTORY, false),
            Map.entry(NAV_BAR_SHOW_PLAYLISTS, false),
