...
public class NavigationBar extends HorizontalScrollView {
    ...
    public void update() {
        ...
        boolean isShorts = Constants.PAGE_SHORTS.equals(pageClass);
        boolean showInShorts = extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.SHOW_NAV_BAR_IN_SHORTS);
        ...
        String orderStr = com.codelabsk.litepipe.extension.Constant.DEFAULT_NAV_BAR_ORDER;
        if (kv != null) {
            orderStr = kv.decodeString(com.codelabsk.litepipe.extension.Constant.NAV_BAR_ORDER, com.codelabsk.litepipe.extension.Constant.DEFAULT_NAV_BAR_ORDER);
        }
        if (orderStr == null) orderStr = com.codelabsk.litepipe.extension.Constant.DEFAULT_NAV_BAR_ORDER;
        ...
        for (String key : order) {
            switch (key.trim()) {
                case "home":
                    if (extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_HOME))
                        visibleItems.add(new NavItemInfo(R.drawable.ic_home, R.string.nav_home, pageClass.equals(Constants.PAGE_HOME), () -> {
                            if (tabManager.getWebview() != null && Constants.HOME_URL.equals(tabManager.getWebview().getUrl())) {
                    ...
                    break;
                case "music":
                    if (extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_MUSIC))
                    ...
                    break;
                case "shorts":
                    if (extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_SHORTS))
                        visibleItems.add(new NavItemInfo(R.drawable.ic_shorts, R.string.nav_shorts, pageClass.equals(Constants.PAGE_SHORTS), () -> tabManager.openTab("https://m.youtube.com/shorts", Constants.PAGE_SHORTS)));
                    break;
                case "subscriptions":
                    if (signedIn && !isIncognito && extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_SUBSCRIPTIONS))
                    ...
                    break;
                case "history":
                    if (signedIn && !isIncognito && extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_HISTORY))
                    ...
                    break;
                case "playlists":
                    if (signedIn && !isIncognito && extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_PLAYLISTS))
                    ...
                    break;
                case "library":
                    if (extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_LIBRARY)) {
                        int icon = isIncognito ? R.drawable.ic_incognito : R.drawable.ic_library;
                        visibleItems.add(new NavItemInfo(icon, R.string.nav_library, pageClass.equals(Constants.PAGE_LIBRARY), () -> tabManager.openTab("https://m.youtube.com/feed/library", Constants.PAGE_LIBRARY)));
                    }
                    break;
                case "downloads":
                    if (extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_DOWNLOADS))
                    ...
                    break;
                case "settings":
                    if (extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.NAV_BAR_SHOW_SETTINGS))
    ...
    private void addNavItem(int iconRes, int labelRes, boolean isSelected, int width, float weight, Runnable action) {
        ...
        if (!extensionManager.isEnabled(com.codelabsk.litepipe.extension.Constant.HIDE_NAV_BAR_LABELS)) {
