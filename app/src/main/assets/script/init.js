    ...
    if (!window.injected) {
        ...
        const showShortsSpeedToast = () => {
            ...
            if (!toast) {
                ...
                toast.style.cssText = 'position:fixed;top:12%;left:50%;transform:translateX(-50%);z-index:99999;background:rgba(0,0,0,0.6);color:#fff;font-size:15px;font-weight:700;padding:5px 12px;border-radius:18px;pointer-events:none;letter-spacing:0.02em;transition:opacity 0.15s;';
                toast.textContent = '2×';
        ...
        const makeBtnSvg = (iconD) => {
            ...
            svg.style.cssText = 'width:20px!important;height:20px!important;display:block!important;fill:currentColor!important;color:currentColor!important;visibility:visible!important;opacity:1!important;';
            const path = document.createElementNS(ns, 'path');
            path.setAttribute('d', iconD);
            svg.appendChild(path);
            return svg;
        ...
        const createYtActionButton = (id, textKey, iconD, clickFn) => {
            ...
            wrapper.style.cssText = 'display:inline-flex!important;align-items:center!important;justify-content:center!important;width:auto!important;height:36px!important;flex:0 0 auto!important;min-width:48px!important;padding:0 12px!important;margin-right:8px!important;background:rgba(255,255,255,0.1)!important;border-radius:18px!important;visibility:visible!important;opacity:1!important;';
        ...
        const observer = new MutationObserver((mutations) => {
            ...
            if (isLive) targetOrder.push({ id: 'chatButton', key: 'chat', icon: 'M240-384h336v-72H240v72Zm0-132h480v-72H240v72Zm0-132h480v-72H240v72ZM96-96v-696q0-29.7 21.15-50.85Q138.3-864 168-864h624q29.7 0 50.85 21.15Q864-821.7 864-792v480q0 29.7-21.15 50.85Q821.7-240 792-240H240L96-96Zm114-216h582v-480H168v522l42-42Zm-42 0v-480 480Z', fn: () => openLiveChat(getVideoId(location.href)) });
